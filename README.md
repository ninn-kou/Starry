...
- [games](https://github.com/leereilly/games) <br>
...
- [leetcode](https://github.com/azl397985856/leetcode) <br> LeetCode Solutions: A Record of My Problem Solving Journey. (leetcode题解，记录自己的leetcode解题之路。) <br>    <http://lucifer.ren/leetcode/>
- [LeetCode-Go](https://github.com/halfrost/LeetCode-Go) <br> ✅ Solutions to LeetCode by Go, 100% test coverage, runtime beats 100% / LeetCode 题解
...
- [pgdoc-cn](https://github.com/postgres-cn/pgdoc-cn) <br>
...
- [fucking-algorithm](https://github.com/labuladong/fucking-algorithm) <br> 手把手撕LeetCode题目，扒各种算法套路的裤子。English version supported! Crack LeetCode, not only how, but also why. <https://labuladong.gitbook.io/algo/>
...
- [pytorch-CycleGAN-and-pix2pix](https://github.com/junyanz/pytorch-CycleGAN-and-pix2pix) <br>
...
- [mathquill](https://github.com/mathquill/mathquill) <br>
